...
def generate_factor_dataframe(fac_generator, 
    ...
    factor_dict['FAC_ADTMMA_askdommean'] = fac_generator.FAC_ADTMMA('askdommean')
    factor_dict['FAC_ADTM_first'] = fac_generator.FAC_ADTM('first')
    factor_dict['FAC_ADTM_last'] = fac_generator.FAC_ADTM('last')
    factor_dict['FAC_ADTM_skewness'] = fac_generator.FAC_ADTM('skewness')
    ...
    factor_dict['FAC_BIDDEPTH_vwap'] = fac_generator.FAC_BIDDEPTH('vwap')
    ...
    factor_dict['FAC_KDJ_max'] = fac_generator.FAC_KDJ('max')
    factor_dict['FAC_KDJ_min'] = fac_generator.FAC_KDJ('min')
    factor_dict['FAC_MAX_max'] = fac_generator.FAC_MAX('max')
    factor_dict['FAC_MCIA_MADmean'] = fac_generator.FAC_MCIA('MADmean')
    ...
    factor_dict['FAC_MCIB_corrBidwap'] = fac_generator.FAC_MCIB('corrBid')
    ...
    factor_dict['FAC_MPC_downmean'] = fac_generator.FAC_MPC('downmean')
    factor_dict['FAC_OFI2_MADmean'] = fac_generator.FAC_OFI2('MADmean')
    factor_dict['FAC_OFI2_first'] = fac_generator.FAC_OFI2('first')
    ...
    factor_dict['FAC_ORDER_SLOPE_B_vwap'] = fac_generator.FAC_ORDER_SLOPE_B('vwap')
    ...
    factor_dict['FAC_PVcorrsub_a1b1_first'] = fac_generator.FAC_PVcorrsub_a1b1('first')
    factor_dict['FAC_PVcorrsub_a2b2_biddommean'] = fac_generator.FAC_PVcorrsub_a2b2('biddommean')
    factor_dict['FAC_PVcorrsub_a2b2_std'] = fac_generator.FAC_PVcorrsub_a2b2('std')
    ...
    factor_dict['FAC_QUA_mean'] = fac_generator.FAC_QUA('mean')
    ...
    factor_dict['FAC_RUSHSTOPASK_biddommean'] = fac_generator.FAC_RUSHSTOPASK('biddommean')
    ...
    factor_dict['FAC_VWAP_Deviation_first'] = fac_generator.FAC_VWAP_Deviation('first')
    factor_dict['FAC_ask1_vmean_20_biddommean'] = fac_generator.FAC_ask1_vmean_20('biddommean')
    factor_dict['FAC_ask1_vmean_20_vwap'] = fac_generator.FAC_ask1_vmean_20('vwap')
    ...
    factor_dict['FAC_money_flow_power_biddommean'] = fac_generator.FAC_money_flow_power('biddommean')
    ...
    # ========== 跨品种因子 (16个) ==========
    factor_dict['A_Y_closepctchg5_sub'] = fac_generator.closepctchg_sub(main_symbol='Y', symbol1='A', symbol2='Y', window=5)
    ...
    factor_dict['M_Y_volumediv5_diff5'] = fac_generator.volumediv_diff(main_symbol='Y', symbol1='M', symbol2='Y', window1=5, window2=5)
    factor_dict['P_Y_closepctchg20_sub'] = fac_generator.closepctchg_sub(main_symbol='Y', symbol1='P', symbol2='Y', window=20)
    factor_dict['P_Y_closepctchg5_sub'] = fac_generator.closepctchg_sub(main_symbol='Y', symbol1='P', symbol2='Y', window=5)
    factor_dict['P_Y_cvcorr10_diff'] = fac_generator.cvcorr10_diff(main_symbol='Y', symbol1='P', symbol2='Y')
    factor_dict['P_Y_vcorr10'] = fac_generator.vcorr10(main_symbol='Y', symbol1='P', symbol2='Y')
    factor_dict['P_Y_volumediv20_diff5'] = fac_generator.volumediv_diff(main_symbol='Y', symbol1='P', symbol2='Y', window1=20, window2=5)
    factor_dict['P_Y_volumediv5_diff5'] = fac_generator.volumediv_diff(main_symbol='Y', symbol1='P', symbol2='Y', window1=5, window2=5)
    # ========== 普通因子 (26个) ==========
