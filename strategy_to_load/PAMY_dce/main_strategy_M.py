...
def generate_factor_dataframe(fac_generator, 
    ...
    factor_dict['FAC_ASKDEPTH_Mstdwap'] = fac_generator.FAC_ASKDEPTH('Mstdwap')
    ...
    factor_dict['FAC_Depth_Reversal_corrBidwap'] = fac_generator.FAC_Depth_Reversal('corrBid')
    ...
    factor_dict['FAC_Hurst_max'] = fac_generator.FAC_Hurst('max')
    ...
    factor_dict['FAC_MPC_corrAskwap'] = fac_generator.FAC_MPC('corrAsk')
    ...
    factor_dict['FAC_OFI2_upmean'] = fac_generator.FAC_OFI2('upmean')
    factor_dict['FAC_OFI3_MADmean'] = fac_generator.FAC_OFI3('MADmean')
    factor_dict['FAC_OFI3_last'] = fac_generator.FAC_OFI3('last')
    factor_dict['FAC_OFI5_max'] = fac_generator.FAC_OFI5('max')
    factor_dict['FAC_OFI5_upmean'] = fac_generator.FAC_OFI5('upmean')
    ...
    factor_dict['FAC_ORDER_SLOPE_B_corrAskwap'] = fac_generator.FAC_ORDER_SLOPE_B('corrAsk')
    factor_dict['FAC_PIR_TrendRevmean'] = fac_generator.FAC_PIR('trend_rev')
    factor_dict['FAC_PIR_std'] = fac_generator.FAC_PIR('std')
    factor_dict['FAC_PRICE_STD_A_upmean'] = fac_generator.FAC_PRICE_STD_A('upmean')
    ...
    factor_dict['FAC_PRICE_VOL_CORR_A_Mstdwap'] = fac_generator.FAC_PRICE_VOL_CORR_A('Mstdwap')
    ...
    factor_dict['FAC_PVcorrsub_a3b3_first'] = fac_generator.FAC_PVcorrsub_a3b3('first')
    ...
    factor_dict['FAC_QUA_max'] = fac_generator.FAC_QUA('max')
    ...
    factor_dict['FAC_RTN_JUMP_kurtosis'] = fac_generator.FAC_RTN_JUMP('kurtosis')
    factor_dict['FAC_RUSHSTOPASK_first'] = fac_generator.FAC_RUSHSTOPASK('first')
    ...
    factor_dict['FAC_ask1_vmean_20_corrBidwap'] = fac_generator.FAC_ask1_vmean_20('corrBid')
    ...
    factor_dict['FAC_ask5_vmean_20_upmean'] = fac_generator.FAC_ask5_vmean_20('upmean')
    ...
    factor_dict['P_M_closepctchg20_sub'] = fac_generator.closepctchg_sub(main_symbol='M', symbol1='P', symbol2='M', window=20)
    factor_dict['P_M_closepctchg5_sub'] = fac_generator.closepctchg_sub(main_symbol='M', symbol1='P', symbol2='M', window=5)
    factor_dict['P_M_cvcorr10_diff'] = fac_generator.cvcorr10_diff(main_symbol='M', symbol1='P', symbol2='M')
    factor_dict['P_M_oi5_diff'] = fac_generator.oi5_diff(main_symbol='M', symbol1='P', symbol2='M')
    factor_dict['P_M_vcorr10'] = fac_generator.vcorr10(main_symbol='M', symbol1='P', symbol2='M')
    factor_dict['P_M_volumediv20_diff5'] = fac_generator.volumediv_diff(main_symbol='M', symbol1='P', symbol2='M', window1=20, window2=5)
    factor_dict['P_M_volumediv5_diff5'] = fac_generator.volumediv_diff(main_symbol='M', symbol1='P', symbol2='M', window1=5, window2=5)
    # ========== 普通因子 (32个) ==========
    ...
    factor_dict['RPP_3M'] = fac_generator.RPP_3M()
