...
def generate_factor_dataframe(fac_generator, 
    ...
    factor_dict['P_A_volumediv20_diff5'] = fac_generator.volumediv_diff(main_symbol='P', symbol1='P', symbol2='A', window1=20, window2=5)
    ...
    factor_dict['P_M_volumediv20_diff5'] = fac_generator.volumediv_diff(main_symbol='P', symbol1='P', symbol2='M', window1=20, window2=5)
